...
protein_filter = st.sidebar.slider('Percentage of protein', 0, 100, 50)
carbs_filter = st.sidebar.slider('Percentage of carbs', 0, 100, 50)
fat_filter = st.sidebar.slider('Percentage of fat', 0, 100, 50)
